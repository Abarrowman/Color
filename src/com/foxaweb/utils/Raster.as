...
package com.foxaweb.utils{
	...
	public class Raster extends BitmapData {
		...
		* Draw a thick line
		* 
		* @param x0first point x coord
		* @param y0first point y coord 
		* @param x1second point x coord
		* @param y1second point y coord
		* @param ccolor (0xaarrvvbb)
		* @param rradius
		*/
		public function thickline( x0:int, y0:int, x1:int, y1:int, color:uint, r:int ):void {
			for (var n:int=-r; n<r; n++) {
				for (var en:int=-r; en<r; en++) {
					var d:Number=Math.sqrt(n*n+en*en);
					if (d<r) {
						line(x0+n,y0+en,x1+n,y1+en,color);
					}
				}
			}
		}
		...
		* @param x1second point x coord
		* @param y1second point y coord
		* @param x2third point x coord
		* @param y2third point y coord
		* @param ccolor (0xaarrvvbb)
		*/
		...
		* Draw a circle
		* 
		* @param pxfirst point x coord
		* @param pyfirst point y coord 
		* @param rradius
		* @param ccolor (0xaarrvvbb)
		*/
		...
		*/
		public function aaLine( x1:int, y1:int, x2:int, y2:int, color:uint ):void {
			...
			if (steep) {
				...
				drawAlphaPixel(xpx2, ypx2,alpha,color);
			...
			if (steep) {
				...
				drawAlphaPixel(xpx2, ypx2 + 1,alpha,color);
			...
			while (x++<xpx2) {
				...
				if (steep) {
					...
					drawAlphaPixel(x,intery,alpha,color);
				...
				if (steep) {
					...
					drawAlphaPixel(x,intery+1,alpha,color);
